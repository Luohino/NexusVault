...
local style = require "colors.nexusvault"
local command
local keymap
local dirwatch
local ime
...
--
-- DATADIR is the location of the installed NexusVault Lua code, default color
-- schemes and fonts.
-- USERDIR is the location of the NexusVault configuration directory.
--
...
function core.init()
  core.log_items = {}
  core.log_quiet("NexusVault version %s - mod-version %s", VERSION, MOD_VERSION_STRING)
  ...
  if #plugins_refuse_list.userdir.plugins > 0 or #plugins_refuse_list.datadir.plugins > 0 then
    ...
    core.nag_view:show(
      ...
      string.format(
        ...
        "Please download a recent version from https://github.com/NexuVault/NexuVault-plugins.",
...
function core.compose_window_title(title)
  return (title == "" or title == nil) and "NexusVault" or title .. " - NexusVault"
end
