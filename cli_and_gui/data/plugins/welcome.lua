...
local buttons = {
  { label = "Install Addons Package", command = "welcome:install-addons", tooltip = {
    "Installs syntax highlightings, themes, and plugins that make NexusVault easier to use.",
    "",
    "Recommended for newcomers to NexusVault.",
    "Requires a network connection."
  } },
  { label = "Open Plugin Manager", command = "welcome:open-plugin-manager", tooltip = { "Manually select plugins you'd like to install before beginning with NexusVault.", "", "Requires a network connection." } },
