      ...
      <div className="flex -space-x-3">
        {visibleAvatars.map((avatar, idx) => {
          ...
          return (
            <div
              key={idx}
              className="border-4 border-white rounded-full bg-white transition-all duration-300 relative"
              style={{
                width: size,
                height: size,
              ...
              <AnimatePresence>
                {isHovered && avatar.label && (
                  <motion.div
                    ...
                    className="absolute z-50 px-2 py-1 bg-black text-white text-xs rounded shadow-lg whitespace-nowrap pointer-events-none font-semibold"
                    style={{
                      top: -size * 0.7,
                      left: "50%",
                    }}
        ...
        {extraCount > 0 && (
          <div
            className="flex items-center justify-center bg-gray-100 text-black font-semibold border-4 border-white rounded-full"
            style={{
              width: size,
              height: size,
              marginLeft: -overlap,
