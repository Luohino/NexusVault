...
export default function AboutSection2() {
  ...
  return (
    <section className="py-32 px-4 bg-gray-50 min-h-[70vh]">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="flex-1">
            ...
            >
              ...
              code collaboration to be more reliable and always developer-first. Our
            ...
            <div className="mt-12 flex gap-2 justify-between items-center">
              <TimelineContent
                as="div"
                animationNum={4}
                timelineRef={heroRef}
