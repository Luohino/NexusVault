...
export const Component = ({
  ...
  return (
    <svg width={width} height={height}>
      <rect width={width} height={height} fill={greens[0]} rx={12} />
      <LinePath
        stroke={greens[2]}
        strokeWidth={3}
        data={data}
      ...
      >
        ...
        {labelType === 'svg' ? (
          ...
          >
            <h3 style={{ margin: '0 0 0.5em', fontWeight: 600, color: orange }}>{title}</h3>
            <p style={{ margin: 0, color: greens[2] }}>{subtitle}</p>
          </HtmlLabel>
        )}
