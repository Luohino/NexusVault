        ...
        <div className="relative z-10 p-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <h2 className="text-4xl font-bold text-white max-w-md tracking-tight">
              Scale your vision with <span className="text-red-600">limitless</span> collaboration.
            </h2>
            <p className="text-gray-500 max-w-sm text-lg">
              Join the elite circle of developers. Built for speed, engineered for security.
            </p>
          </div>
        </div>
      </div>
