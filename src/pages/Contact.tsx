...
import { Mail, Github, Twitter, Linkedin, Youtube, Instagram, ArrowRight } from 'lucide-react';
      ...
      <main className="flex-1 w-full flex flex-col items-center justify-center p-6 text-center pt-20">
        <div className="max-w-3xl w-full">
          ...
          <div className="bg-white border-2 border-zinc-100 shadow-2xl rounded-3xl p-8 md:p-16 relative overflow-hidden group">
            {/* Background Accent */}
            <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-red-50 rounded-full opacity-50 group-hover:scale-150 transition-transform duration-700"></div>

            <div className="relative z-10 flex flex-col items-center">
              <img
                src="https://github.com/Luohino.png"
                alt="Luohino"
                className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-xl mb-6 md:mb-8 group-hover:scale-105 transition-transform"
              />
              ...
              <div className="flex justify-center items-center -space-x-3 mb-10">
                {SOCIAL_LINKS.map((social, idx) => (
                  ...
                  >
                    ...
                    <div className="w-12 h-12 rounded-full border-2 border-white bg-white flex items-center justify-center text-zinc-400 group-hover/icon:text-black group-hover/icon:border-black transition-all shadow-md">
                      {social.icon}
                    </div>
                  </a>
                ))}
